...
>
    ...
    <div class="flex h-16 shrink-0 items-center justify-between border-b border-slate-700/60 px-4">
        <a href="{{ route('dashboard') }}" class="flex min-w-0 items-center gap-3">
            ...
            <span x-show="!sidebarCollapsed" x-cloak class="truncate text-sm font-semibold tracking-tight text-white">DMS</span>
        </a>
    ...
    <nav class="flex-1 overflow-y-auto overflow-x-hidden px-3 py-4 space-y-0.5 scrollbar-thin">
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['masters.view', 'products.view', 'customers.view', 'price-master.view']))
            <p x-show="!sidebarCollapsed" x-cloak class="{{ $sectionClass }}">Masters</p>
            @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['products.view', 'masters.view']))
            ...
            @endif
            @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['customers.view', 'masters.view']))
            ...
            @endif
            @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['price-master.view', 'masters.view']))
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['orders.view', 'orders.create', 'orders.edit', 'orders.book', 'orders.manage', 'create orders']))
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['inventory.view', 'stock.view', 'purchases.view']))
            <p x-show="!sidebarCollapsed" x-cloak class="{{ $sectionClass }}">Inventory</p>
            @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['stock.view', 'inventory.view']))
            ...
            @endif
            @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['purchases.view', 'inventory.view']))
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['sales.view', 'invoices.view', 'sales.create', 'invoices.create']))
            <p x-show="!sidebarCollapsed" x-cloak class="{{ $sectionClass }}">Sales</p>
            @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['sales.view', 'invoices.view']))
            ...
            @endif
            @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['sales.create', 'invoices.create']))
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['payments.view', 'payments.create', 'payments.edit', 'payments.reconcile']))
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['logistics.view', 'logistics.create', 'logistics.edit', 'logistics.manage']))
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['delivery.view', 'delivery.create', 'delivery.edit', 'delivery.manage']))
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['settlement.view', 'settlement.create', 'settlement.edit', 'settlement.manage', 'manage settlements', 'settlement.entry']))
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasAnyPermission(['reports.view', 'reports.create', 'reports.edit', 'reports.manage']))
