...
<x-ui.button variant="primary" :href="route('organization.branches.create')">Add</x-ui.button>
</x-slot>
</x-ui.page-header>
<x-ui.card>
...
<td class="px-3 py-2 text-right whitespace-nowrap"><x-ui.button variant="secondary" size="sm" :href="route('organization.branches.edit', $item)">Edit</x-ui.button></td>
</tr>
@empty
