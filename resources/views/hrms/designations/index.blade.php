...
@section('content')
<x-ui.page-header title="Designations"><x-slot name="actions"><x-ui.button variant="primary" :href="route('hrms.designations.create')">Add</x-ui.button></x-slot></x-ui.page-header>
...
<td class="px-3 py-2 text-right"><x-ui.button variant="secondary" size="sm" :href="route('hrms.designations.edit', $item)">Edit</x-ui.button></td></tr>
