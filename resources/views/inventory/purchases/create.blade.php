...
<x-ui.input name="purchase_date" label="Purchase Date" type="date" :value="old('purchase_date', now()->toDateString())" required />
<x-ui.input name="supplier_name" label="Supplier Name" :value="old('supplier_name')" required />
<div>
<label class="block text-sm font-medium text-slate-700 mb-1">Supplier Party</label>
<select name="supplier_party_id" class="block w-full rounded-lg border-gray-300 text-sm">
