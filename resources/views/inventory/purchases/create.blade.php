...
<div class="overflow-x-auto border rounded-lg"><table class="min-w-full text-sm"><thead class="bg-gray-50"><tr><th class="px-3 py-2 text-left">Product</th><th class="px-3 py-2 text-left">UOM</th><th class="px-3 py-2 text-left">Qty</th><th class="px-3 py-2 text-left">Cost</th><th></th></tr></thead><tbody id="line-items"><tr>
...
<td class="px-3 py-2"><input type="number" step="0.01" name="items[0][unit_cost]" class="block w-full rounded-lg border-gray-300 text-sm" required></td><td></td></tr></tbody></table></div>
