...
<label class="flex items-center gap-2 text-sm pt-6"><input type="checkbox" name="low_stock" value="1" @checked(request('low_stock')) class="rounded border-gray-300"> Low stock only</label>
