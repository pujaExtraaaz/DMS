...
class OutstandingLedgerService
{
    ...
    public function recordCreditNote(\App\Domains\Payment\Models\CreditNote $creditNote): OutstandingLedger
    {
        return $this->recordEntry(
            ...
            debit: 0,
            credit: (float) $creditNote->grand_total,
            notes: "Credit note {$creditNote->credit_note_no}",
        );
    }
